...
1. 陆向谦实验室（LU LAB）所有产品及服务（以下统称「陆向谦实验室产品」）是由视算新里程科技\(北京\)有限公司代表LU LAB提供的互联网产品和服务。
...
__5\. 陆向谦实验室有权根据需要不时地修订本协议及/或各类规则（包括但不限于制定新的条款和修改既有条款），并以在线公告的方式进行变更公告。若您在前述公告修订后继续使用陆向谦实验室的产品或服务，即视为您已阅读、理解并接受经过修订的协议和规则。若您不同意修订，应当立即停止使用陆向谦实验室提供的产品和服务。__
...
__2\. 陆向谦实验室将尽力提供畅通无阻的在线服务，但平台的网络接入服务可能受多种因素的影响出现链接受阻、受限或被终止，由此给您带来的损失、不便，我们将不负任何责任。__

3\. 陆向谦实验室提供的部分产品和服务须付费使用，用户使用此类产品需要向陆向谦实验室支付一定的费用。对于收费的产品和服务，我们会在用户使用之前给予用户明确的提示，只有用户根据提示确认其愿意支付相关费用，用户才能使用/继续使用该等收费产品和服务。__如用户拒绝支付相关费用，则陆向谦实验室有权不向用户提供该等收费产品和服务。__
...
6\.1 用户使用第三方开发者提供的应用与服务时，第三方开发者将根据用户的授权获得用户的个人资料和内容信息。这些资料和信息由用户自行决定授权给第三方。关于您使用第三方应用与服务时个人信息处理的规则和规范，均以《隐私政策》规定的内容为准。__用户须明确：您向第三方授权获得您个人资料和内容信息的行为，可能发生的信息泄露的风险；您在使用第三方服务的同时，除遵守本协议及陆向谦实验室的其他相关规则外，您还应遵守第三方的协议、相关规则。如因第三方软件及相关服务产生的争议、损失或损害，由您自行与第三方解决， 陆向谦实验室对此不承担责任。__

__6\.2 陆向谦实验室引入第三方服务的目的在于丰富陆向谦实验室产品，从而给用户创造更好的服务体验。但因第三方服务出现的瑕疵或错误而产生的责任，由第三方自行承担，与陆向谦实验室无关。当然，陆向谦实验室会对第三方提供的服务进行审查或审核，但基于服务的专业性，难免存在遗漏。第三方服务商并不因陆向谦实验室的审查或审核疏漏而免于责任承担。__

6\.3 陆向谦实验室对第三方开发者提供的应用享有审核管理权，有权在不通知用户的情况下，对第三方应用进行下架处理，由此给用户带来的影响、损失，陆向谦实验室将不承担责任，由用户自行承担或与第三方协商，但陆向谦实验室将尽力保障用户权益不受侵犯。

__6\.4 用户使用第三方应用登录时，可以选择授权陆向谦实验室在符合相关法律法规要求的前提下读取并获得您在该第三方平台上公布、记录的公开信息（包括昵称、头像、地区、性别等）。我们需要您授权从第三方获取上述信息是为了记住您作为陆向谦实验室用户的登录身份。 在您使用第三方帐号注册或登录后，您的第三方帐号将会与陆向谦实验室帐号进行绑定。__
...
6\.会员服务费用全部捐赠给陆向谦实验室（LU LAB）。

7\. 陆向谦实验室保留在法律法规允许的范围内自行决定是否接受您的会员服务申请、调整会员服务内容、取消会员资格等权利。

8\.未成年人购买会员时与成人同价，需监护人代为购买。
...
1\. 您在注册账号或使用陆向谦实验室产品和服务的过程中，可能需要填写一些必要的信息。若国家法律法规有特殊规定的，您需要填写真实的身份信息。若您填写的信息不完整，可能无法使用陆向谦实验室的产品或服务，或在使用过程中受到限制。关于处理您个人信息的详细规定，请参见《隐私政策》。__您须对在陆向谦实验室的注册信息的真实性、合法性、有效性承担全部责任，不得冒充他人；不得利用他人的名义发布任何信息；不得恶意使用注册账户导致其他用户误认；否则陆向谦实验室有权立即停止提供服务，收回其账户并由用户独自承担由此而产生的一切法律责任。__

2\. 您可以随时浏览、修改自己提交的信息，但出于安全性和身份识别（如账号申诉服务）的考虑，您可能无法修改注册时提供的部分初始注册信息及其他验证信息。陆向谦实验室保留您修改个人信息的审核权。关于您对个人信息享有权利的详细规定，请参见《隐私政策》。

__3\. 原则上陆向谦实验室不会将您的个人信息控制权向其他公司、组织或个人进行转移。如果发生合并、收购或破产清算，将涉及到个人信息转让，我们将依照《隐私政策》规定处理您的个人信息。__

__4\. 陆向谦实验室非常重视对未成年人信息的保护。若您是18周岁以下的未成年人，在使用陆向谦实验室的服务前，您请在父母或监护人监护、指导下共同仔细阅读并理解本用户协议，并在征得您的父母或监护人同意的前提下使用我们的服务或向我们提供信息。如因您违反法律法规、本协议内容，则您及您的监护人应依照法律规定承担因此而导致的一切后果。__
...
您确认，在您完成注册程序或以其他陆向谦实验室允许的方式实际使用 陆向谦实验室提供的产品和服务时，__您应当是具备完全民事权利能力和完全民事行为能力的自然人、法人或其他组织。若您不具备前述主体资格，则您及您的监护人应承担因此而导致的一切后果，且陆向谦实验室有权注销或永久冻结您的账户，并保留向您或您的监护人索取赔偿的权利。__

__18周岁以下的未成年人等非完全民事行为能力人应该在法定监护人的指导下使用陆向谦实验室的产品和服务。__
...
__3\. 陆向谦实验室在此特别提醒您务必保护好您的账号及密码，切勿将账号及密码透露给他人。您须自行负责对您的账户和密码进行保密，且须对在您的账户和密码下发生的所有活动（包括但不限于信息披露、信息发布、网上点击同意或提交各类规则协议、网上续签协议或购买服务等）承担责任。陆向谦实验室不能也不会对因您未能遵守本条款规定而发生的任何损失负责。若您发现任何人未经授权使用您的账号及密码，您须立即通知陆向谦实验室 。你可以陆向谦实验室官方客服提出您的请求。您须理解并同意陆向谦实验室根据您的请求采取行动需要合理时间，对在采取行动前已产生的任何不利后果，陆向谦实验室不承担任何责任。因其他人恶意攻击或您自身原因或其他不可抗因素而导致账号盗窃、丢失、均由您本人承担责任，陆向谦实验室不承担任何责任。__

__4\. 您可以对账户设置昵称，您设置的昵称不得侵犯或涉嫌侵犯他人的合法权益。用户承诺设置昵称时遵守以下规定：__
...
__如您设置的昵称涉嫌侵犯他人合法权益，陆向谦实验室有权终止向您提供部分或全部软件服务。陆向谦实验室对此不承担任何责任，您将承担因此产生的任何直接或间接损失及不利后果。__
...
__（3）除用户与陆向谦实验室另有约定，用户不得对陆向谦实验室中的任何数据/资料作商业性利用，包括但不限于在未经陆向谦实验室事先书面同意的情况下，以复制、传播等任何方式使用陆向谦实验室中展示的所有资料或课程。__
...
（5）对于用户在陆向谦实验室中上传、发布、存储作品和内容（包括但不限于图片、视频、音频、文字作品、肖像品等），用户保证其对该等作品享有合法著作权/版权或者相应授权，并且 __用户同意授予陆向谦实验室对所有上述作品和内容的在全球范围内的免费、不可撤销的、无限期的、并且可转让的非独家使用权许可，__ 陆向谦实验室有权展示、散布及推广前述内容，有权对前述内容进行任何形式的复制、修改、出版、发行及以其他方式使用或者授权第三方进行复制、修改、出版、发行及以其他方式使用。陆向谦实验室可能会将前述作品和内容用于自身的推广或其他合法目的，若您不同意授权给陆向谦实验室使用，还请联系我们。

__（6）对于用户在陆向谦实验室产品上涉嫌违法、违约或侵犯他人合法权利的内容、产品，陆向谦实验室有权不经通知予以删除，且不承担任何责任。__

__九、【免责声明】__

__1\. 用户理解并同意，在使用陆向谦实验室产品和服务的过程中，可能会遇到不可抗力等风险因素，使服务发生中断、延迟。不可抗力是指不能预见、不能克服并不能避免且对一方或双方造成重大影响的客观事件，包括但不限于自然灾害（如洪水、台风、地震等）、社会事件（如战争、暴动、政府行为）等，出现上述情况时，陆向谦实验室会努力对产品和服务进行修复，但由此给您造成的损失，陆向谦实验室在法律允许的范围内免责。__

__2\. 在法律允许的范围内，陆向谦实验室对以下情形导致的服务终端或受阻不承担责任：__

__（1）受到计算机病毒、木马或其他恶意程序、黑客攻击的破坏；__

__（2）用户或陆向谦实验室的电脑软件、系统、硬件和通信线路出现故障；__

__（3）用户操作不当；__

__（4）用户使用非陆向谦实验室授权的方式使用本服务；__

__（5）其他陆向谦实验室无法控制或合理预见的情形。__

__3\. 用户理解并同意，在使用陆向谦实验室产品和服务的过程中，可能会遇到网络信息或其他用户带来的风险和损害，陆向谦实验室不对任何信息或产品的真实性、适用性、合法性承担责任，也不对因侵权行为给您造成的损害负责。这些风险包括但不限于：__

__（1）来自他人匿名或冒名的含有威胁、诽谤、令人反感或非法内容的信息；__

__（2）因使用本协议项下产品或服务，遭受他人误导、欺骗或其他导致或可能导致的任何心理、生理以及经济上的损害。__

__4\. 陆向谦实验室依据本协议享有处理不法、违规内容、产品或服务的权利，但该权利不构成陆向谦实验室的义务和承诺，陆向谦实验室不保证及时发现并做出相应处理。__

__5\. 对于单项产品运营者通过陆向谦实验室向您提供的单项产品或服务，由单项产品运营者独立承担与该项产品或服务有关的全部责任和义务，其他陆向谦实验室对此不承担任何责任和义务。__
...
3\. 除法律另有规定外，__用户有责任自行备份存储在陆向谦实验室的数据，如用户的服务被终止，陆向谦实验室有权从服务器上永久地删除您在陆向谦实验室的全部相关数据，并不负有向您返还或以任何形式提供前述数据的义务。__
...
3\. 若您与陆向谦实验室运营者发生任何纠纷或争议，首先应友好协商解决；协商不成的，__您同意将纠纷或争议提交至北京仲裁委员会在北京仲裁解决。仲裁裁决是终局的，对双方均有约束力。__
