          ...
          child: Column(
            ...
            children: [
              SizedBox(
               ...
               Container(
                margin: const EdgeInsets.fromLTRB(80, 150, 0, 0),
                child: const Text(
                  "Our Mission\n",
                  style: TextStyle(
                    fontSize: 60.0,
               ...
               Container(
                margin: const EdgeInsets.fromLTRB(80, 230, 0, 0),
                child: const Text(
...
mindset for success\n
                ...
                children: [
                  Container(
            margin: const EdgeInsets.fromLTRB(80, 540, 0, 0),
                height: 580,
                width: 400,
              ...
              Container(
                margin: const EdgeInsets.fromLTRB(0, 540, 0, 0),
                height: 580,
                width: 530,
                 decoration: BoxDecoration( 
                  color: Colors.black,
